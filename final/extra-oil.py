...
# Run 2 oil and E storage
init_movement()
init_fly_swatter()
init_sword()

position_fly_swatter(360,70)

#drive to oil platform
drive_distance(north,15,100)
set_heading(north_east)
drive_distance(north_east,25,100)
drive_until_line(north_east,45)
drive_distance(north_east,7)
set_heading(west,20)
position_fly_swatter(0)
drive_distance(west,15)

#activate oil platform
for i in range(3):
    position_fly_swatter(15)
    position_fly_swatter(0)

#
drive_distance(west,-4)
set_heading(north)
