...
# TODO: Initialize dispenser
# TODO: Operate dispenser
...
# activates TV
drive_distance(north, 45)
drive_distance(north, -10)

# drive to windmill
drive_distance(north_west,28)

# activate windmill
for step in range(0,4):
	drive_distance(north_east)
...
# drive to power plant with sword down
set_heading(south)
position_sword(90)
drive_heading(south)
stop_on_line()
drive_distance(south,-5)

# activate power plant
position_sword(70,80)
position_fly_swatter(180)
drive_distance(south,-10)
position_sword(0)
position_fly_swatter(360)
...
# activate smart grid
position_fly_swatter(30)
position_fly_swatter(0)
drive_distance(north,-10)
position_fly_swatter(360)

# drive to oil refinery
drive_distance(north,-10)
drive_heading(west)
stop_on_line()

# activate oil refinery
position_fly_swatter(0)
drive_distance(west,5)
for step in range(0,4):
	position_fly_swatter(20)
	position_fly_swatter(0)
drive_distance(west,-35)
position_fly_swatter(360)

# drive to hydro electric
drive_distance(south_west,10)

# activate hydro electric
position_sword(40,50)
position_sword()

# drive to energy storage
drive_heading(west)
stop_on_line()
drive_distance(north,30)

# grab power unit tray
position_fly_swatter(0)

# drive home
drive_distance(north,-70)
