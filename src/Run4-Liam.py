...
# dispense model in power to x
dispense()

# go to energy storage
drive_distance(north_west,45)
drive_distance(west,35)

# drop energy units in energy storage
for step in range(0,3):
	drop()

# go home
drive_distance(west,-20)
drive_distance(south_west,80)