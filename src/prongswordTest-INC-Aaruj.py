...
def position_dropper(position=0,power=50):
...
drive_distance(north,5,speed)
set_heading(west)
drive_distance(west,15,speed)
set_heading(north_west)
drive_time(north_west,1.5,speed)
drive_distance(north_west,-2,speed)
set_heading(north_west)
set_heading(north_west)
...
drive_distance(north_west,30,-1*speed)
set_heading(west)
drive_distance(west,40,speed)
set_heading(north_west)
drive_until_line(north_west,speed)
drive_distance(north_west,9,speed)
set_heading(west)
